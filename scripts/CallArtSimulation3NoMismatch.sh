...
# This is the command that should be run with the script
...
$SCRIPT_PATH/CallHaplotypesPE3NoMismatch.sh $OUT_DIR $SIM_1 $SIM_2

# Score the called haplotypes with the true haplotypes
perl $SCRIPT_PATH/score-sim-call3.pl -t $OUT_DIR/sim_chosen_haplotypes.txt -p $OUT_DIR/haplotypes.txt > $OUT_DIR/sim-score.txt
